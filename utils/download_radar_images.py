...
if __name__ == '__main__':
    ...
    parser.add_argument('--end_day', type=int, default=29,
                        help='an integer for the accumulator')
    parser.add_argument('--start_month', type=int, default=1,
                        help='an integer for the accumulator')
    parser.add_argument('--end_month', type=int, default=1,
                        help='an integer for the accumulator')
    ...
    parser.add_argument('--save_folder', type=str, default="RainRealImages",
                        help='directory name to save images')
